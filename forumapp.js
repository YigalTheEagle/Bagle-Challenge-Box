...
app.get('/', (req,res) =>{
	...
	res.write('<body>');
	res.write("<h1 align='center'>Welcome to <yellow>Bagle</yellow> Challenge Box</h1>");
...
app.get('/bamba',(req,res)=>{
	...
	else
	{
		...
		{
			res.send('<script>alert("Lol noob you need to login first");document.location="/bamba"</script>');
		}
	}
})
