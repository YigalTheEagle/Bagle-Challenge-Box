...
app.get('/admin',(req,res)=>{
	res.send('<script>alert("Lol skiddie you need the API token");document.location="/admin"</script>');
});
app.get('/forumapi',(req,res)=>{
	...
	{
		res.send('<script>alert("Lol skiddie you need the API token");document.location="/forumapi"</script>');
	}
});
...
app.get('/authenticatedjs',(req,res)=>{
	...
	{
		res.send('<script>alert("Lol skiddie you need the API token");document.location="/authenticatedjs"</script>');
	}
});
app.post('/',(req,res) =>{
